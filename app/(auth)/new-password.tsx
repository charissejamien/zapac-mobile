          ...
          >
            ...
            >
              <View style={{ width: 346 }}>
                ...
                <Text className="text-xs text-[#888] mb-5">Must be at least 8 characters.</Text>

                <Text className="text-sm text-[#333] font-medium mb-[7px]">Confirm Password</Text>
                <View className="relative mb-1">
                  <TextInput
                    className="bg-input-bg rounded-[12px] px-[14px] pr-12 h-[56px] w-full text-base text-[#1A1A1A]"
                ...
                <Text className="text-xs text-[#888] mb-8">Both passwords must match.</Text>
